...
def test_save_daily_creates_file(csv_storage):
    rows = [{"date": "2026-03-30", "open": 70000.0, "high": 71000.0, "low": 69000.0, "close": 70500.0, "volume": 35000.0}]
...
def test_save_fundamentals_creates_file(csv_storage):
    data = {"fetched_at": "2026-03-30T00:00:00+00:00", "market_cap": 1_400_000_000_000.0, "market_cap_rank": 1, "total_volume_24h": 35_000_000_000.0, "circulating_supply": 19_800_000.0, "category": "Layer 1"}
